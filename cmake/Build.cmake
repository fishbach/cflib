...
if(ENABLE_PCH)
    ...
    target_include_directories(pch_core PRIVATE "${PROJECT_SOURCE_DIR}")
    target_compile_features(pch_core PRIVATE cxx_std_20)
    target_link_libraries(pch_core PRIVATE cflib_base)
endif()
