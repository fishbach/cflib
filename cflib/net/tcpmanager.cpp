...
TCPConnData * TCPManager::openConnection(const ByteArray & destAddress, uint16 destPort, bool preferIPv6)
{
    return impl_->openConnection(destAddress, destPort, ByteArray(), 0, 0, preferIPv6);
}

TCPConnData * TCPManager::openConnection(const ByteArray & destAddress, uint16 destPort,
    const ByteArray & sourceIP, uint16 sourcePort, bool preferIPv6)
{
    return impl_->openConnection(destAddress, destPort, sourceIP, sourcePort, 0, preferIPv6);
}

TCPConnData * TCPManager::openTLSConnection(const ByteArray & destAddress, uint16 destPort, bool preferIPv6)
{
    return impl_->openConnection(destAddress, destPort, ByteArray(), 0, &impl_->clientCredentials, preferIPv6);
}

TCPConnData * TCPManager::openTLSConnection(const ByteArray & destAddress, uint16 destPort,
    const ByteArray & sourceIP, uint16 sourcePort, bool preferIPv6)
{
    return impl_->openConnection(destAddress, destPort, sourceIP, sourcePort, &impl_->clientCredentials, preferIPv6);
}

int TCPManager::openListenSocket(const ByteArray & ip, uint16 port)
{
